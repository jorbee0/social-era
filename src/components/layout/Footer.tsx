                ...
                <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 text-center md:text-left">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="space-y-1">
                            <p className="text-blue-100/60 text-sm font-inter">
                                <a href="tel:9555675223" className="hover:text-brand-primary transition-colors hover:underline">9555675223</a>
                            </p>
                            <p className="text-blue-100/60 text-sm font-inter lowercase">
                                <a href="mailto:tothesocialeradigitalpvtltd@gmail.com" className="hover:text-brand-primary transition-colors hover:underline">tothesocialeradigitalpvtltd@gmail.com</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-right">
                        ...
                        <div className="flex justify-center md:justify-end space-x-4">
                            <a href="#" className="text-blue-100/30 hover:text-white transition-colors">
