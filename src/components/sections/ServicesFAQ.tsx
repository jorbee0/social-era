...
const faqs = [
  {
    ...
    answer:
      "Typically, our corporate partners see significant traction within the first 90 days. For performance marketing, initial optimization happens within 14-21 days, followed by scaling.",
  },
  {
    question: "Do you provide custom reporting dashboards?",
    answer:
      "Yes, every partner receives a live, 24/7 transparent dashboard that syncs all KPIs across search, social, and web performance metrics.",
  },
  {
    question: "What is your typical engagement model?",
    answer:
      "We prefer structured 6-12 month growth partnerships, though we do handle high-stakes tactical deployments for specific seasonal or launch-based objectives.",
  },
  {
    question: "How do you handle brand governance and security?",
    answer:
      "We follow strict corporate security protocols and brand guideline adherence systems. Every piece of content and every strategic shift passes through a formal governance loop.",
  },
];
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-1.5 bg-brand-primary/5 border border-brand-primary/10 rounded-full mb-6">
            <span className="text-[10px] font-black uppercase tracking-widest text-brand-primary leading-none">
              FAQs
            </span>
          </div>
