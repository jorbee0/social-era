...
const services = [
  {
    ...
    description:
      "Strategic content creation and community growth for corporate brands, focused on authority and engagement.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "High-ROI performance marketing across search and social platforms, driven by data and precision targeting.",
    icon: (
      <svg
        className="w-8 h-8 text-brand-primary"
        fill="none"
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zM12 2a10 10 0 100 20 10 10 0 000-20z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M12 11v2m0 0l-1-1m1 1l1-1"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    description:
      "Technical optimization and premium corporate web experiences built for visibility, speed, and conversion.",
    icon: (
      <svg
        className="w-8 h-8 text-brand-primary"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Specialized digital advocacy, voter engagement systems, and high-impact digital messaging for political leadership.",
    icon: (
      <svg
        className="w-8 h-8 text-brand-primary"
        fill="none"
      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-text-muted leading-relaxed font-inter">
            We provide structured digital services tailored for established
            brands and organizations that demand precision, authority, and
            measurable growth.
          </p>
        </div>
