...
const steps = [
  {
    ...
    description:
      "In-depth analysis of your market, competitors, and growth opportunities to build a solid foundation.",
  },
  {
    number: "02",
    title: "Planning & Execution",
    description:
      "Developing a custom roadmap and deploying performance-driven campaigns with precision.",
  },
  {
    number: "03",
    title: "Performance Optimization",
    description:
      "Real-time monitoring and data-driven adjustments to ensure maximum impact and efficiency.",
  },
  {
    number: "04",
    title: "Growth & Scale",
    description:
      "Scaling successful models to achieve sustainable market leadership and long-term results.",
  },
];
      ...
      <div className="container-custom mb-20 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-text-muted font-inter">
            Success is built on a foundation of rigorous research and
            disciplined execution. Our 4-step process ensures consistent,
            authority-driven results.
          </p>
        </div>
      </div>
          ...
          {allSteps.map((step, index) => (
            ...
            >
              <div className="w-24 h-24 bg-white rounded-full border-4 border-slate-50 shadow-sm flex items-center justify-center mb-8 shrink-0">
                <span className="text-brand-primary font-black text-2xl font-outfit">
                  {step.number}
                </span>
              </div>
