            ...
            <div className="container-custom relative z-10 text-center">
                <div className="max-w-5xl mx-auto">
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-slate-900 dark:text-white leading-[1.05] mb-10 font-outfit tracking-tighter">
                        Transform Your <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-accent">Digital Presence</span> <br />
                        Into A Market Force.
                    </h1>

                    <p className="text-xl md:text-2xl text-slate-600 dark:text-white/60 leading-relaxed mb-14 max-w-3xl mx-auto font-inter">
                        Strategic, process-driven performance systems engineered for modern corporations seeking unprecedented digital growth.
                    </p>

                    <div className="flex justify-center">
                        <Link href="#services-grid" className="group relative overflow-hidden bg-brand-primary text-white px-12 py-5 rounded-full text-lg font-black transition-all hover:scale-105 active:scale-95 shadow-xl shadow-brand-primary/20">
                            <span className="relative z-10 flex items-center justify-center uppercase tracking-widest text-sm">
                                Explore Services <span className="ml-2 transition-transform group-hover:translate-x-1">→</span>
                            </span>
