      ...
      <div className="container-custom">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white font-outfit tracking-tighter leading-tight">
            How We Are Doing It{" "}
            <span className="text-brand-primary underline decoration-4 underline-offset-8">
              Faster
            </span>{" "}
            <br />
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              <div className="absolute inset-x-8 bottom-8">
                ...
                <h3 className="text-2xl font-black text-white font-outfit group-hover:text-brand-primary transition-colors duration-500">
                  {item.title}
                </h3>
              </div>
            </Link>
