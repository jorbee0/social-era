                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-slate-50 border-b border-slate-200">
                            <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Case Study Title</th>
                            <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Industry</th>
                        ...
                        {loading ? (
                            <tr>
                                <td colSpan={5} className="px-8 py-12 text-center">
                                    ...
                                    <span className="text-sm font-medium text-slate-400 uppercase tracking-widest">Synchronizing Data...</span>
                                </td>
                            </tr>
                        ) : filtered.length === 0 ? (
                            <tr>
                                <td colSpan={5} className="px-8 py-12 text-center">
                                    <p className="text-slate-400 font-medium">No results found matching your search.</p>
                                </td>
                            </tr>
                        ) : filtered.map((cs) => (
                            <tr key={cs._id} className="hover:bg-slate-50 transition-colors group">
                                <td className="px-8 py-6">
                                    <span className="text-sm font-bold text-slate-800">{cs.title}</span>
                                </td>
                                <td className="px-8 py-6">
                                ...
                                <td className="px-8 py-6 text-right">
                                    <div className="flex justify-end items-center space-x-2">
                                        ...
                                        >
                                            {cs.isPublished ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                                        </button>
                                        <Link
