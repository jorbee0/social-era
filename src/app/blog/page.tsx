...
export const metadata = {
  ...
  description:
    "Read our latest articles on technology, design, and business strategy.",
};
          ...
          <article key={post} className="group cursor-pointer">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-600 line-clamp-2">
                Exploring the latest trends in fullstack development and how
                businesses can leverage new technologies.
              </p>
