        ...
        <div className="container-custom">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-text-muted dark:text-white/60 leading-relaxed font-inter animate-fade-in-up delay-100">
              The Social Era Digital Pvt. Ltd. is a premium corporate growth
              partner dedicated to transforming digital presence into
              authoritative market leadership.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in-up delay-200">
              <h2 className="text-sm uppercase tracking-[0.3em] font-bold text-brand-primary mb-4">
                Company Overview
              </h2>
              ...
              <div className="space-y-4 text-text-muted dark:text-white/60 leading-relaxed font-inter">
                <p>
                  Founded on the principle that digital growth should be
                  structured, measurable, and authoritative, Social Era has
                  emerged as a trusted partner for corporations seeking refined
                  digital scaling.
                </p>
                <p>
                  We don&apos;t just provide services; we build performance systems.
                  Our approach combines technical excellence with deep market
                  intelligence to ensure every digital touchpoint serves a
                  strategic purpose.
                </p>
              </div>
            </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-10 rounded-2xl bg-white dark:bg-white/[0.03] border border-slate-100 dark:border-white/10 shadow-sm hover:shadow-xl transition-all duration-500 animate-fade-in-up delay-200">
              ...
              <h4 className="text-2xl font-bold mb-4 font-outfit">
                Our Mission
              </h4>
              <p className="text-text-muted dark:text-white/60 leading-relaxed font-inter">
                To empower brands with structured digital systems that drive
                predictable growth, establishing them as absolute authorities in
            ...
            <div className="p-10 rounded-2xl bg-white dark:bg-white/[0.03] border border-slate-100 dark:border-white/10 shadow-sm hover:shadow-xl transition-all duration-500 animate-fade-in-up delay-300">
              ...
              <p className="text-text-muted dark:text-white/60 leading-relaxed font-inter">
                To become the global gold standard for corporate digital growth,
                recognized for our unwavering commitment to process, precision,
                and ROI.
              </p>
            </div>
          </div>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors duration-500 animate-fade-in-up"
