...
const industries = [
  ...
  },
  {
    name: "Media",
    image:
      "https://images.unsplash.com/photo-1598897500632-d8558485600c?auto=format&fit=crop&q=80&w=1000",
      ...
      <section className="pt-32 pb-16 bg-white dark:bg-[#0A0D14]">
        <div className="container-custom">
          ...
          <p className="text-xl text-text-muted dark:text-white/60 leading-relaxed max-w-2xl font-inter animate-fade-in-up">
            Deep expertise across various sectors to deliver industry-specific
            results and scalable performance systems.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {industries.map((industry, i) => (
              <div
                key={i}
                className="group relative aspect-[4/6] rounded-2xl overflow-hidden cursor-pointer bg-brand-dark border border-white/10 shadow-2xl"
              >
                {/* Image Layer */}
