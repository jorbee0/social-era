...
const detailedServices = [
    {
        ...
        outcome: "Increased share of voice, 24/7 brand sentiment protection, and a highly qualified community ready for conversion.",
    ...
    },
    {
        ...
        outcome: "A premium asset library that drives trust, reduces inquiry-to-close time, and upholds your brand benchmarks.",
    ...
    },
    {
        ...
        outcome: "Consistent, measurable ROI and a stable pipeline of sales-qualified leads (SQLs) delivered with absolute transparency.",
    ...
    },
    {
        ...
        outcome: "Explosive growth in direct phone inquiries, map-driven foot traffic, and 'near-me' search dominance.",
    ...
    },
    {
        ...
        outcome: "A high-performance digital HQ with sub-second load times and a structured environment for market leadership.",
        image: "https://images.unsplash.com/photo-1551288049-bbbda536ad0a?auto=format&fit=crop&q=80&w=1000",
        bg: "bg-white dark:bg-[#0A0D14]"
    },
    {
        id: "seo",
        ...
        outcome: "Sustainable organic traffic growth, reduced dependency on paid ads, and long-term search engine authority.",
    ...
    },
    {
        ...
        outcome: "Mobilized voter bases, clear-cut messaging dominance, and the digital tools necessary to win on a grand scale.",
    ...
    return (
        <main className="bg-white dark:bg-[#0A0D14] transition-colors duration-500">
                ...
                <div className="container-custom">
                    <div className="max-w-4xl">
                        <div className="inline-flex items-center px-4 py-1.5 bg-brand-primary/5 dark:bg-brand-primary/10 border border-brand-primary/10 rounded-full mb-8">
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-brand-primary leading-none">Market Leadership</span>
                        </div>
                        ...
                        <p className="text-lg md:text-xl text-slate-600 dark:text-white/60 leading-relaxed font-inter max-w-2xl">
                            We provide the high-stakes digital infrastructure and performance systems necessary for modern organizations to scale with precision and authority.
                        </p>
                    </div>
                </div>
            </section>
            ...
            {detailedServices.map((service, i) => (
                <section key={service.id} className={`py-24 ${service.bg} transition-colors duration-500 overflow-hidden`}>
                    <div className="container-custom">
                        <div className={`flex flex-col ${i % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-16 lg:gap-24`}>
                            ...
                            <div className="w-full lg:w-1/2">
                                <span className="text-[10px] font-black text-brand-primary uppercase tracking-[0.4em] block mb-6">Service {i + 1}</span>
                                ...
                                <div className="space-y-10">
                                    <div>
                                        <h3 className="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-white/30 mb-3">WHAT WE DO</h3>
                                        <p className="text-lg text-slate-700 dark:text-white/80 leading-relaxed font-inter">
                                            {service.what}
                                        </p>
                                    </div>
                                    <div>
                                        <h3 className="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-white/30 mb-3">HOW WE DO</h3>
                                        <p className="text-slate-600 dark:text-white/50 leading-relaxed font-inter italic">
                                            {service.how}
                                        </p>
                                    </div>
                                    <div>
                                        <h3 className="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-white/30 mb-3">EXPECTED OUTCOME</h3>
                                ...
                                <div className="mt-14">
                                    <Link href="/contact" className="inline-flex items-center justify-center bg-brand-primary text-white px-10 py-4 rounded-full text-sm font-black uppercase tracking-widest hover:bg-brand-dark transition-all duration-300 shadow-xl shadow-brand-primary/20 hover:-translate-y-1">
